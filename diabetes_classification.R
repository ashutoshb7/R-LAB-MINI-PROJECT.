...
# load the data
filename="C:\\Users\\Admin\\Downloads\\R-Lab-Mini-Project-master\\R-EDA&Prediction\\diabetes_data.csv"
...
fit.rafo_default <- train(glyhb~., data=trainingData, method="rf", metric=metric, tuneGrid=tunegrid, preProc=c("center","scale"), trControl=control.rf)
print(fit.rafo_default$results) # accuracy = 0.9114924

#4. parameter tunning via grid search for random forest
control.rf_search <- trainControl(method="repeatedcv", number=6, repeats=3, search="grid")
set.seed(7)
...
saveRDS(fit.rf_gridsearch, "C:\\Users\\Admin\\Downloads\\R-Lab-Mini-Project-master\\R-EDA&Prediction\\diabetes_classification1")
  
# load the model from the disk
#C:\Users\Admin\Downloads\R-Lab-Mini-Project-master\R-EDA&Prediction
final_model <- readRDS("C:\\Users\\Admin\\Downloads\\R-Lab-Mini-Project-master\\R-EDA&Prediction\\diabetes_classification1")
...
print(confusionMatrix$table)
#save the final classifier model into disk
saveRDS(fit.rf_gridsearch, "C:\\Users\\Admin\\Downloads\\R-Lab-Mini-Project-master\\R-EDA&Prediction\\diabetes_classification1\\diabetes_classification1")
# load the model from the disk
final_model <- readRDS("C:\\Users\\Admin\\Downloads\\\\R-Lab-Mini-Project-master\\R-EDA&Prediction\\diabetes_classification1\\diabetes_classification1")
#final_model <- readRDS("C:\\data\\diabetes_classification")
 print(final_model)
 # make predictions using the loaded model
set.seed(7)
